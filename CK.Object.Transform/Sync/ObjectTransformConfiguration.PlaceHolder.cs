...
{
    public abstract partial class ObjectTransformConfiguration
    {
        /// <summary>
        ...
        public ObjectTransformConfiguration? TrySetPlaceholder( IActivityMonitor monitor,
        ...
        {
            builderError = false;
            ObjectTransformConfiguration? result = null;
        ...
        public virtual ObjectTransformConfiguration SetPlaceholder( IActivityMonitor monitor, IConfigurationSection configuration )
        {
            return this;
        }
