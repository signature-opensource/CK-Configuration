...
namespace CK.Object.Transform
{
    ...
    public abstract partial class ObjectAsyncTransformConfiguration : IObjectTransformConfiguration
    {
        ...
        public virtual ObjectAsyncTransformHook? CreateHook( IActivityMonitor monitor, ITransformEvaluationHook hook, IServiceProvider services )
        {
        ...
        /// <param name="hook">The evaluation hook.</param>
        /// <returns>A wrapper bound to the evaluation hook or null for an identity function.</returns>
        public ObjectAsyncTransformHook? CreateHook( IActivityMonitor monitor, ITransformEvaluationHook hook ) => CreateHook( monitor, hook, EmptyServiceProvider.Instance );
