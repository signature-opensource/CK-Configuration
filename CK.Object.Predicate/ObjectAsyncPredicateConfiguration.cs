...
namespace CK.Object.Predicate
{
    ...
    public abstract partial class ObjectAsyncPredicateConfiguration : IObjectPredicateConfiguration
    {
        ...
        static PolymorphicConfigurationTypeBuilder.StandardTypeResolver? _defaultAsyncResolver;
        ...
        /// <summary>
        /// Adds a <see cref="PolymorphicConfigurationTypeBuilder.TypeResolver"/> for asynchronous and synchronous predicates.
        /// <list type="bullet">
        ...
        public static PolymorphicConfigurationTypeBuilder.StandardTypeResolver AddResolver( PolymorphicConfigurationTypeBuilder builder, bool allowOtherNamespace = false, string compositeItemsFieldName = "Predicates" )
        {
            ...
            var sync = new PolymorphicConfigurationTypeBuilder.StandardTypeResolver(
            ...
            var async = new PolymorphicConfigurationTypeBuilder.StandardTypeResolver(
            ...
            static PolymorphicConfigurationTypeBuilder.StandardTypeResolver AddDefault( PolymorphicConfigurationTypeBuilder builder )
            {
                ...
                if( _defaultAsyncResolver == null )
                {
                    ...
                    {
                        _defaultAsyncResolver ??= new PolymorphicConfigurationTypeBuilder.StandardTypeResolver(
                                                            baseType: typeof( ObjectAsyncPredicateConfiguration ),
                                                            typeNamespace: "CK.Object.Predicate",
                                                            familyTypeNameSuffix: "AsyncPredicate",
                                                            tryCreateFromTypeName: TryCreateAsyncFromTypeName,
